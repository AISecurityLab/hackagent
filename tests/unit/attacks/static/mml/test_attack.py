...
from hackagent.attacks.techniques.static.mml.attack import MMLAttack, _recursive_update
from hackagent.attacks.techniques.static.mml.config import DEFAULT_MML_CONFIG
...
class TestMMLAttackPipelineSteps:
    ...
    def test_pipeline_step_functions(self, mock_base_init):
        ...
        from hackagent.attacks.techniques.static.mml import generation
...
class TestMMLAttackRun:
    ...
    @patch("hackagent.attacks.techniques.base.BaseAttack.__init__", return_value=None)
    @patch(
        "hackagent.attacks.techniques.static.mml.attack.MMLAttack._initialize_coordinator"
    )
    @patch("hackagent.attacks.techniques.static.mml.attack.MMLAttack._execute_pipeline")
