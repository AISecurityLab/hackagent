...
Tests the FlipAttack class from hackagent.attacks.techniques.static.flipattack.attack
...
Run with:
    pytest tests/unit/attacks/static/flipattack/test_flipattack_core.py --run-integration
"""
...
from hackagent.attacks.techniques.static.flipattack.attack import (
