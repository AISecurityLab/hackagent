...
class TestGraphvizBootstrapHelpers(unittest.TestCase):
    ...
    def test_resolve_dot_binary_skip_download_when_disallowed(self):
        with (
            ...
            patch(
                "hackagent.attacks.techniques.static.fc.flowchart_renderer._GRAPHVIZ_DOT_BIN",
                None,
            ),
            patch(
                "hackagent.attacks.techniques.static.fc.flowchart_renderer.shutil.which",
                return_value=None,
            ),
            patch(
                "hackagent.attacks.techniques.static.fc.flowchart_renderer._fetch_graphviz_latest_release"
            ) as mock_fetch,
        ):
    ...
    def test_ensure_graphviz_dot_available_forwards_allow_download(self):
        with patch(
            "hackagent.attacks.techniques.static.fc.flowchart_renderer._resolve_dot_binary",
            return_value=None,
        ) as mock_resolve:
    ...
    def test_hackagent_data_dir_windows_localappdata(self):
        with (
            ...
            patch(
                "hackagent.attacks.techniques.static.fc.flowchart_renderer.platform.system",
    ...
    def test_hackagent_data_dir_macos(self):
        with (
            ...
            patch(
                "hackagent.attacks.techniques.static.fc.flowchart_renderer.Path.home",
