...
from hackagent.attacks.techniques.static.fc import generation as fcgen
...
from hackagent.attacks.techniques.static.fc.prompts import SYSTEM_PROMPT, USER_PROMPT
