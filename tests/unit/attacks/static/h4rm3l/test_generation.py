...
from hackagent.attacks.techniques.static.h4rm3l.generation import (
...
class TestBuildPromptingInterface(unittest.TestCase):
    ...
    @patch("hackagent.attacks.techniques.static.h4rm3l.generation.connect_role")
    ...
    @patch(
        "hackagent.attacks.techniques.static.h4rm3l.generation.connect_role",
