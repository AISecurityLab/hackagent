...
from hackagent.attacks.techniques.adaptive.advprefix import completions
...
class TestAdvPrefixCompletionTracking(unittest.TestCase):
    ...
    @patch(
        "hackagent.attacks.techniques.adaptive.advprefix.completions.create_progress_bar"
    )
