...
class TestAutoDANTurboAttack(unittest.TestCase):
    ...
    @patch(
        "hackagent.attacks.techniques.adaptive.autodan_turbo.attack.evaluation.execute"
    )
    @patch(
        "hackagent.attacks.techniques.adaptive.autodan_turbo.attack.lifelong.execute"
    )
    @patch("hackagent.attacks.techniques.adaptive.autodan_turbo.attack.warm_up.execute")
