...
from hackagent.attacks.techniques.adaptive.autodan_turbo import log_styles
...
class TestLogStyles(unittest.TestCase):
    ...
    def test_apply_color_respects_flag(self):
        with patch(
            "hackagent.attacks.techniques.adaptive.autodan_turbo.log_styles._color_enabled",
            return_value=False,
        ):
