...
try:
    from hackagent.attacks.techniques.adaptive.autodan_turbo import warm_up
...
class TestWarmUp(unittest.TestCase):
    ...
    @patch("hackagent.attacks.techniques.adaptive.autodan_turbo.warm_up.score_response")
    @patch("hackagent.attacks.techniques.adaptive.autodan_turbo.warm_up.query_target")
    @patch(
    ...
    @patch("hackagent.attacks.techniques.adaptive.autodan_turbo.warm_up.init_routers")
    @patch(
    ...
    @patch(
        "hackagent.attacks.techniques.adaptive.autodan_turbo.warm_up.score_response",
