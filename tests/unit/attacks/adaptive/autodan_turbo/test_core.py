...
from hackagent.attacks.techniques.adaptive.autodan_turbo import core
...
class TestCoreHelpers(unittest.TestCase):
    ...
    @patch("hackagent.attacks.techniques.adaptive.autodan_turbo.core.connect_role")
...
class TestCoreGenerationAndScoring(unittest.TestCase):
    @patch(
        "hackagent.attacks.techniques.adaptive.autodan_turbo.core.extract_response_content"
    )
    ...
    def test_score_response_invalid_thinking_defaults_to_false(self, _mock_extract):
        scorer_router = MagicMock()
        scorer_router.route_request.return_value = {"dummy": True}
