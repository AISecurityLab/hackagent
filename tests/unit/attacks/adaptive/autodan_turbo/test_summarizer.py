...
from hackagent.attacks.techniques.adaptive.autodan_turbo import summarizer
...
class TestSummarizeStrategy(unittest.TestCase):
    @patch(
        "hackagent.attacks.techniques.adaptive.autodan_turbo.summarizer.extract_response_content"
    )
