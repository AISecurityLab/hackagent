...
try:
    from hackagent.attacks.techniques.adaptive.autodan_turbo import lifelong
...
class TestLifelong(unittest.TestCase):
    ...
    @patch(
        "hackagent.attacks.techniques.adaptive.autodan_turbo.lifelong.score_response"
    )
    @patch("hackagent.attacks.techniques.adaptive.autodan_turbo.lifelong.query_target")
    @patch(
    ...
    @patch("hackagent.attacks.techniques.adaptive.autodan_turbo.lifelong.init_routers")
