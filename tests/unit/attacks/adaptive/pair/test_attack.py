...
from hackagent.attacks.techniques.adaptive.pair.attack import PAIRAttack, _deep_update
...
class TestPAIRScorerPrecedence(unittest.TestCase):
    ...
    def test_assessment_score_drives_threshold_and_traces(self):
        ...
        from hackagent.attacks.techniques.adaptive.autodan_turbo.config import (
...
class TestPAIRAttack(unittest.TestCase):
    ...
    def test_run_uses_global_goal_index_offset_for_tracking_context(self):
        ...
        with (
            ...
            patch(
                "hackagent.attacks.techniques.adaptive.pair.attack.create_progress_bar",
    ...
    def test_score_response_passes_original_goal_to_scorer(self):
        ...
        with patch(
            "hackagent.attacks.techniques.adaptive.pair.attack.score_response",
            return_value=(7.5, "ok"),
        ) as mock_score:
