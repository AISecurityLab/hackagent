...
def test_build_context_keeps_connected_judges_and_ignores_a_bad_threshold(tmp_path):
...
def test_unconnectable_judge_falls_back_to_the_missing_judge(tmp_path):
    ctx, *_rest = _build(
        tmp_path,
