...
from hackagent.storage._http.api.checkout import checkout_create
...
from hackagent.storage._http.api.models import CheckoutSessionResponse
from hackagent.storage._http.api.models import GenericErrorResponse
...
def test_sync_success(
    ...
    with patch(
        "hackagent.storage._http.api.checkout.checkout_create.sync_detailed",
...
async def test_asyncio_success(
    ...
    with patch(
        "hackagent.storage._http.api.checkout.checkout_create.asyncio_detailed",
