...
from hackagent.storage._http.api.result import (
    result_create,
    result_destroy,
    result_list,
...
from hackagent.storage._http.api.models import PaginatedResultList
from hackagent.storage._http.api.models import PatchedResultRequest
from hackagent.storage._http.api.models import Result
from hackagent.storage._http.api.models import ResultRequest
from hackagent.storage._http.api.models import (
    StepKind,
)  # Ensuring this import is present
from hackagent.storage._http.api.models import Trace
from hackagent.storage._http.api.models import TraceRequest  # For creating traces


class TestResultListAPI(unittest.TestCase):
    @patch("hackagent.storage._http.api.result.result_list.AuthenticatedClient")
    def test_result_list_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "hackagent.storage._http.api.result.result_list.PaginatedResultList.model_validate",
...
class TestResultCreateAPI(unittest.TestCase):
    @patch("hackagent.storage._http.api.result.result_create.AuthenticatedClient")
    def test_result_create_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "hackagent.storage._http.api.result.result_create.Result.model_validate",
...
class TestResultRetrieveAPI(unittest.TestCase):
    @patch("hackagent.storage._http.api.result.result_retrieve.AuthenticatedClient")
    def test_result_retrieve_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "hackagent.storage._http.api.result.result_retrieve.Result.model_validate",
            return_value=mock_parsed_result,
        ) as mock_model_validate:
...
class TestResultUpdateAPI(unittest.TestCase):
    @patch("hackagent.storage._http.api.result.result_update.AuthenticatedClient")
    def test_result_update_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "hackagent.storage._http.api.result.result_update.Result.model_validate",
            return_value=mock_parsed_result,
        ) as mock_model_validate:
...
class TestResultPartialUpdateAPI(unittest.TestCase):
    @patch(
        "hackagent.storage._http.api.result.result_partial_update.AuthenticatedClient"
    )
    def test_result_partial_update_sync_detailed_success_patch_evaluation(
        ...
        with patch(
            "hackagent.storage._http.api.result.result_partial_update.Result.model_validate",
            return_value=mock_parsed_result,
        ) as mock_model_validate:
...
class TestResultDestroyAPI(unittest.TestCase):
    @patch("hackagent.storage._http.api.result.result_destroy.AuthenticatedClient")
...
class TestResultTraceCreateAPI(unittest.TestCase):
    @patch("hackagent.storage._http.api.result.result_trace_create.AuthenticatedClient")
    def test_result_trace_create_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "hackagent.storage._http.api.result.result_trace_create.Trace.model_validate",
