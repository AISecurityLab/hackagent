...
- Indirect Prompt Injection is documented as a dedicated risk scenario under **Cybersecurity** for RAG systems.
...
- **Documented Dedicated Scenario**: Indirect Prompt Injection (RAG context poisoning)
...
For the currently implemented configuration, see [Jailbreak](/risks/vulnerabilities) and [Indirect Prompt Injection](/risks/indirect-prompt-injection).
...
| [Indirect Prompt Injection](/risks/indirect-prompt-injection) | Dedicated risk scenario for poisoned retrieved context in RAG pipelines |
