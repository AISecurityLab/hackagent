...
title: hackagent.attacks.techniques.static.mml.attack
---
...
- `config` - Optional dictionary containing parameters to override
  :data:`~hackagent.attacks.techniques.static.mml.config.DEFAULT_MML_CONFIG`.
...
- `ValueError` - On the legacy path, if `client` or
  ...
  a verdict. :class:`~hackagent.attacks.techniques.static.mml.config.MMLConfig`
