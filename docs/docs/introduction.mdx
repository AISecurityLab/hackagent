...
<div style={{minWidth: '300px', maxWidth: '600px', width: '100%', padding: '1rem', borderRadius: '8px', background: 'var(--ifm-background-surface-color)', border: '1px solid var(--ifm-color-emphasis-300)', textAlign: 'center'}}>
  ...
  <pre style={{padding: '0.5rem 1rem', background: 'var(--ifm-color-emphasis-100)', borderRadius: '4px', fontSize: '0.9rem', margin: 0, overflowX: 'auto'}}><code>{`python3 -m venv .venv\nsource .venv/bin/activate\npip install hackagent`}</code></pre>
  <div style={{marginTop: '0.5rem', fontSize: '0.8rem', color: 'var(--ifm-color-emphasis-600)'}}>Works locally out of the box, with optional cloud sync via HACKAGENT_API_KEY. The terminal UI and dashboard need extras (`hackagent[tui]`, `hackagent[web]`).</div>
</div>
      ...
      <div className="architecture-hover-section">
        ...
        <div className="architecture-hover-content">
          <div style={{display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gap: '0.4rem'}}>
            ...
            <span style={{padding: '0.25rem 0.5rem', background: 'var(--ifm-color-emphasis-100)', borderRadius: '4px', fontSize: '0.75rem', textAlign: 'center'}}>Static Template</span>
          </div>
        </div>
      </div>
    </div>
