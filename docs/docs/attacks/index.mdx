...
Technique authors: the forward constructor is [`BaseAttack(config, ctx)`](./seam.md). The attacks on this page are still launched with the `attack_config` dict above.
:::
