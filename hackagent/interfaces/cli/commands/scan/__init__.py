...
``hackagent.interfaces.cli.commands.scan`` keeps its historical import surface.
...
from hackagent.interfaces.cli.commands.scan.command import scan
from hackagent.interfaces.cli.commands.scan.helpers import (
    DEFAULT_ATTACK_TYPE,
    DEFAULT_GOALS,
    _extract_asr,
    _format_asr,
...
from hackagent.interfaces.cli.commands.scan.quick import run_quick_scan
