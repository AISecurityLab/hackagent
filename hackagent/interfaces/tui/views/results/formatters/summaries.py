...
from hackagent.interfaces.tui.theme import classify_evaluation_status
from hackagent.interfaces.tui.views.results.formatters.text import _escape
from hackagent.interfaces.tui.views.results.formatters.traces import _format_trace_block
...
def _get_result_status_info(result: Any) -> tuple[str, str, str]:
    ...
    vocabulary in :mod:`hackagent.interfaces.tui.theme`: a jailbreak that got through
