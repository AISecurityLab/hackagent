...
class RagAttack(BaseAttack):
    ...
    def __init__(
        ...
        validated = RagConfig.from_dict(current_config)
    ...
    def run(self, goals: Optional[List[str]] = None, **kwargs) -> List[AttackResult]:
        ...
        self.logger.info(f"Starting RAG Attack with {len(goals)} goal(s)")
