...
class StaticTemplateAttack(BaseAttack):
    ...
    :data:`~hackagent.attacks.techniques.static.static_template.config.DEFAULT_TEMPLATE_CONFIG`.
    ...
    Pipeline stages
    ---------------
    1. **Generation** (:func:`~hackagent.attacks.techniques.static.static_template.generation.execute`) —
    ...
    def _get_pipeline_steps(self) -> List[Dict]:
        ...
        **Generation**
            (:func:`~hackagent.attacks.techniques.static.static_template.generation.execute`):
