...
from hackagent.attacks.techniques.indirect.rag.jailbreak import DEFAULT_JAILBREAK_CONFIG
...
class RagConfig(ConfigBase):
    """Typed configuration for the RAG Attack."""
