...
"""
hackagent.catalog.risks — Vulnerability definitions and threat profiles.
...
from hackagent.catalog.risks.registry import (
...
from hackagent.catalog.risks.prompt_injection import PromptInjectionTemplate
